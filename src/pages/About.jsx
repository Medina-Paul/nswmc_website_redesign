...
const About = () => {
  return (
    <Layout>
      {/* This wrapper strictly prevents any horizontal scrolling (scroll x) 
      ...
      */}
      <div className="w-full overflow-x-hidden">
        ...
        <div className="w-full text-center mt-8 md:mt-16 mb-6 md:mb-8 px-3 md:px-0">
        ...
        {/* Reduced mb-24 to mb-8 to fix excessive empty scrolling space at the bottom */}
        <div className="max-w-5xl mt-8 md:mt-16 mx-auto px-3 sm:px-6 md:px-12 mb-8 md:mb-12 transition-colors duration-500">
          {/* Lead Paragraph */}
